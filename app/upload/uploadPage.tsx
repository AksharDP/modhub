        ...
        if (draggedItem && draggedItem !== imageId) {
            setSelectedImages((currentImages) => {
                const draggedIndex = currentImages.findIndex(
                    (img) => img.id === draggedItem
                );
                const dragOverIndex = currentImages.findIndex(
                    (img) => img.id === imageId
                );
                    ...
                    <Form action={formAction} className="space-y-6">
                        ...
                        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                            ...
                            <textarea
                                ...
                                required
                                rows={8}
                                className="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white focus:border-purple-500 focus:outline-none resize-none"
                        ...
                        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white focus:border-purple-500 focus:outline-none file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 file:cursor-pointer cursor-pointer"
                                />
                            </div>
                            <div>
                                <label
                                ...
                                >
                                    ...
                                    {selectedImages.length > 0 && (
                                        <span className="text-gray-400 text-xs ml-2">
                                            (First image is thumbnail. Drag to
                                            reorder.)
                                        </span>
                                    )}
                                </label>
                                                ...
                                                (image, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            {isFirstImage && (
                                                                <div className="absolute bottom-1 left-1 bg-yellow-500 text-black text-xs px-1.5 py-0.5 rounded font-semibold shadow-md">
                                                                    THUMBNAIL
                                                                </div>
                                                            )}
                                                            <button
                                                                ...
                                                                className="absolute top-1 right-1 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs hover:bg-red-700 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
                                                            >
                                                                ×
                                                            </button>
                                                        </div>
