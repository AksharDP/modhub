...
// Type for mod data returned from TRPC
type ModData = {
    id: number;
    title: string;
    slug: string;
...
// Lazy load the Card component with loading fallback
...
export default function Home() {
    const { data: featuredMods, isLoading, error } = trpc.mod.getFeaturedMods.useQuery({ limit: 4 });
            ...
            <>
                ...
                <main className="p-8 text-white">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-gray-400">Loading featured mods...</p>
                    </div>
                </main>
            </>
        );
                    ...
                    <h1 className="text-4xl font-bold text-center mb-8 text-purple-400">
                        ...
                        {featuredMods?.map((mod: ModData) => (
                            <Card
                                ...
                                size="N/A" // We can calculate this from mod files later
                                uploaded={new Date()} // TODO: Add createdAt to schema
                                lastUpdated={new Date()} // TODO: Add updatedAt to schema
                            />
                        ))}
                    </div>
                </div>
